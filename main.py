...
def attack(char_name: str, char_class: str):
    """Описывает расчёт урона в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str):
    """Описывает расчёт блокируемого урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str):
    """Описывает расчёт эффекта от специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """Описание персонажа перед началом тренировки, сама тренировка."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Описывает выбор персонажа и его описание."""
    approve_choice = None
    char_class = None
...
def main():
    """Описывает приветствие, ввод имени."""
